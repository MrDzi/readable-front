import { RECEIVE_COMMENTS, RECEIVE_COMMENT, REMOVE_COMMENT, SET_COMMENTS_SORTING_OPTION, CHANGE_COMMENT_SCORE, EDIT_COMMENT, SET_EDIT_COMMENT_DRAFT, TOGGLE_EDIT_COMMENT_MODAL } from '../actions';
